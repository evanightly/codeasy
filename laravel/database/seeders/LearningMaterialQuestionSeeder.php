...
class LearningMaterialQuestionSeeder extends Seeder {
    ...
    public function run(): void {
        ...
        if ($this->wasExcelImportUsed() && !$forceDevSeeding) {
            $this->info('Skipping learning material questions seeding as courses were imported from Excel.');

            return;
        }

        if ($forceDevSeeding) {
            $this->info('Forcing development seeding for learning material questions...');
        }
