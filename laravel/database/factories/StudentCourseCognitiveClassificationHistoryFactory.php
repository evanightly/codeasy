...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\StudentCourseCognitiveClassificationHistory>
 */
class StudentCourseCognitiveClassificationHistoryFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        return [
            ...
            'student_course_cognitive_classification_id' => $this->faker->numberBetween(1, 1000),
