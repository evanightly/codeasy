                    ...
                    if (child !== content) {
                        return (
                            <Tooltip key={value}>
                                ...
                                <TooltipContent side='bottom' className='z-[51]' align='start'>
                                    {content}
                                </TooltipContent>
                            </Tooltip>
                        );
...
>(({ className, ...props }, ref) => {
    return (
        <CommandList ref={ref} className={ny('max-h-[unset] px-0 py-1', className)} {...props} />
    );
});
    ...
    (
        ...
        return (
            <CommandItem
                ...
                disabled={disabled}
                className={ny(disabled && 'cursor-not-allowed text-muted-foreground', className)}
            >
