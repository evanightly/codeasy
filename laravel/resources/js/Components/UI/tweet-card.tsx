...
function Verified({ className, ...props }: TwitterIconProps) {
    return (
        <svg viewBox='0 0 24 24' className={className} aria-label='Verified Account' {...props}>
            <g fill='currentColor'>
...
export function TweetSkeleton({ className, ...props }: { className?: string; [key: string]: any }) {
    return (
        <div
            className={ny(
...
export function TweetNotFound({ className, ...props }: { className?: string; [key: string]: any }) {
    return (
        <div
            className={ny(
    ...
    return (
        <div className='flex flex-row justify-between tracking-tight'>
            <div className='flex items-center space-x-2'>
                <a target='_blank' rel='noreferrer' href={tweet.user.url}>
                    <img
                        width={48}
            ...
            <a target='_blank' rel='noreferrer' href={tweet.url}>
        ...
        <div className='flex flex-1 items-center justify-center'>
            {tweet.video && (
                <video
                    ...
                    autoPlay
                >
                    <source type='video/mp4' src={tweet.video.variants[0].src} />
